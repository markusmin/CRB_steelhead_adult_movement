#!/bin/bash
## create state history for third quartile of detection histories
...
apptainer exec --bind ../../../:/gscratch/stf/mmin ../cmdstanr_latest.sif Rscript R/hyak/03_create_state_histories/03_create_state_histories_part3.R
