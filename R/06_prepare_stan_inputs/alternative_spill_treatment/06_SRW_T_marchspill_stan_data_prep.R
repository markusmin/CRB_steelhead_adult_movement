...
n.ind <- dim(state_data)[3]
  ...
  # EDIT: if there are any cases where a tributary mouth state was not visited but
  # the tributary upstream state was visited, don't cut it out!
  states_not_visited <- states_not_visited[-11]
  ...
  save(data, file = "Stan/alternative_spill_treatment/snake_river_wild_transported/SRW_T_marchspill_model_data.rda")
