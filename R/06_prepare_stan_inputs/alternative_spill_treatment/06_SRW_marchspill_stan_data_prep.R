# 06 stan data prep: Snake River Wild (alternative spill treatment)
...
n.ind <- dim(state_data)[3]
  ...
  save(data, file = "Stan/alternative_spill_treatment/snake_river_wild/SRW_marchspill_model_data.rda")