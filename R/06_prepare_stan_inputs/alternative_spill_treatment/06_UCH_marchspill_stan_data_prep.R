# 06 stan data prep: Upper Columbia Hatchery (alternative spill treatment)
...
n.ind <- dim(state_data)[3]
  ...
  save(data, file = "Stan/alternative_spill_treatment/upper_columbia_hatchery/UCH_marchspill_model_data.rda")