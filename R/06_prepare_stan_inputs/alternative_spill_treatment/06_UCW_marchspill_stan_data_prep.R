# 06 stan data prep: Upper Columbia Wild (alternative spill treatment)
...
n.ind <- dim(state_data)[3]
  ...
  save(data, file = "Stan/alternative_spill_treatment/upper_columbia_wild/UCW_marchspill_model_data.rda")
