# 06 stan data prep: Snake River Hatchery
...
# KEEP ONLY TRANSPORTED FISH
states_complete %>% 
  subset(transport == 1) -> states_complete
...
n.ind <- dim(state_data)[3]
  ...
  save(data, file = "Stan/alternative_spill_treatment/snake_river_hatchery_transported/SRH_T_marchspill_model_data.rda")