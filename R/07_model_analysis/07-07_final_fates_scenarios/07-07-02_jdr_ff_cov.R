...
# save data
save(JDR_MCN_winterspill_homing, file = "figures/final_fates_scenarios/simulation_runs/JDR_MCN_winterspill_homing.rda")
...
ggsave("figures/final_fates_scenarios/JDR_MCN_winterspill_homing_plot_temps.png", JDR_MCN_winterspill_homing_plot, height = 8, width = 8)