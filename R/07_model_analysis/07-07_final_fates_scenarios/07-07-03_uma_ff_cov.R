...
# save data
save(UMA_MCN_winterspill_homing, file = "figures/final_fates_scenarios/simulation_runs/UMA_MCN_winterspill_homing.rda")
...
ggsave("figures/final_fates_scenarios/UMA_MCN_winterspill_homing_plot_temps.png", UMA_MCN_winterspill_homing_plot, height = 8, width = 8)