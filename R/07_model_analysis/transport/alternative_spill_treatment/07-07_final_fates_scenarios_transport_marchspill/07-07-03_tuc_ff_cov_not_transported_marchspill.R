...
# save output
save(TUC_LGR_winterspill_homing, file = "figures/transport/alternative_spill_treatment/final_fates_scenarios/simulation_runs/TUC_LGR_not_transported_homing.rda")