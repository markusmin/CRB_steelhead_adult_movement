...
load("figures/alternative_spill_treatment/final_fates_scenarios/simulation_runs/TUC_LGR_marchspill_homing.rda")
...
ggsave(here::here("figures", "alternative_spill_treatment", "paper_figures", "Fig8_FF_cov_combined_plot_marchspill.png"), FF_cov_combined_plot, height = 12, width = 16)
