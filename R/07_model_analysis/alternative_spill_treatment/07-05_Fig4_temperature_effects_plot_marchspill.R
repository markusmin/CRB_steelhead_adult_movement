# 07-05_Fig4_temperature_effects_plot - MARCH SPILL
...
plot_compare_rear_temp_effect_multiple_movements <- function(origin_select,
  ...
  if (plot_legend == TRUE){
    ...
    # for testing
    # ggsave(here::here("figures", "alternative_spill_treatment", "paper_figures", "01_legend_test.png"), temp_plot_legend_gg, height = 4, width = 4)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "JDR_wild_compare_movement_temp.png"), JDR_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "UMA_wild_compare_movement_temp.png"), UMA_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "UMA_hatchery_compare_movement_temp.png"), UMA_hatchery_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "YAK_wild_compare_movement_temp.png"), YAK_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "WAWA_wild_compare_movement_temp.png"), WAWA_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "WAWA_hatchery_compare_movement_temp.png"), WAWA_hatchery_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "WEN_wild_compare_movement_temp.png"), WEN_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "WEN_hatchery_compare_movement_temp.png"), WEN_hatchery_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "ENT_wild_compare_movement_temp.png"), ENT_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "TUC_wild_compare_movement_temp.png"), TUC_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "TUC_hatchery_compare_movement_temp.png"), TUC_hatchery_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "IMN_wild_compare_movement_temp.png"), IMN_wild_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "temperature_effects", "IMN_hatchery_compare_movement_temp.png"), IMN_hatchery_compare_movement_temp, height = 8, width = 8)
...
ggsave(here::here("figures", "alternative_spill_treatment", "paper_figures", "Fig4_temperature_home_mainstem.png"), combined_movement_temp_plot, height = 12, width = 16)
...
ggsave(here::here("figures", "alternative_spill_treatment", "paper_figures", "Fig5_deschutes_temp_movements.png"), DES_temp_move_prob_plot, height = 8, width = 10)
