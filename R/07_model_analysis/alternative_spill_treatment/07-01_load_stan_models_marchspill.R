...
SRW_envir <- new.env()
SRH_envir <- new.env()
load(here::here("Stan", "alternative_spill_treatment", "upper_columbia_wild", "UCW_marchspill_model_data.rda"),
     envir = UCW_envir)
load(here::here("Stan", "alternative_spill_treatment", "upper_columbia_hatchery", "UCH_marchspill_model_data.rda"),
     envir = UCH_envir)
load(here::here("Stan", "alternative_spill_treatment", "middle_columbia_wild", "MCW_marchspill_model_data.rda"),
     envir = MCW_envir)
load(here::here("Stan", "alternative_spill_treatment", "middle_columbia_hatchery", "MCH_marchspill_model_data.rda"),
     envir = MCH_envir)
load(here::here("Stan", "alternative_spill_treatment", "snake_river_wild", "SRW_marchspill_model_data.rda"),
     envir = SRW_envir)
load(here::here("Stan", "alternative_spill_treatment", "snake_river_hatchery", "SRH_marchspill_model_data.rda"),
     envir = SRH_envir)
...
## Upper Columbia, Wild
UCW_marchspill_chain1 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_wild", "UCW_marchspill_chain1_fit.rds"))
UCW_marchspill_chain2 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_wild", "UCW_marchspill_chain2_fit.rds"))
UCW_marchspill_chain3 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_wild", "UCW_marchspill_chain3_fit.rds"))
UCW_marchspill_chain4 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_wild", "UCW_marchspill_chain4_fit.rds"))

# bind chains together
UCW_fit_raw <- bind4chains(UCW_marchspill_chain1, UCW_marchspill_chain2, UCW_marchspill_chain3, UCW_marchspill_chain4)
# thin2
...
UCH_marchspill_chain1 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_hatchery", "UCH_marchspill_chain1_fit.rds"))
UCH_marchspill_chain2 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_hatchery", "UCH_marchspill_chain2_fit.rds"))
UCH_marchspill_chain3 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_hatchery", "UCH_marchspill_chain3_fit.rds"))
UCH_marchspill_chain4 <- readRDS(here::here("Stan", "alternative_spill_treatment", "upper_columbia_hatchery", "UCH_marchspill_chain4_fit.rds"))

# bind chains together
UCH_fit_raw <- bind4chains(UCH_marchspill_chain1, UCH_marchspill_chain2, UCH_marchspill_chain3, UCH_marchspill_chain4)
# thin2
...
MCW_marchspill_chain1 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_wild", "MCW_marchspill_chain1_fit.rds"))
MCW_marchspill_chain2 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_wild", "MCW_marchspill_chain2_fit.rds"))
MCW_marchspill_chain3 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_wild", "MCW_marchspill_chain3_fit.rds"))
MCW_marchspill_chain4 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_wild", "MCW_marchspill_chain4_fit.rds"))

# bind chains together
MCW_fit_raw <- bind4chains(MCW_marchspill_chain1, MCW_marchspill_chain2, MCW_marchspill_chain3, MCW_marchspill_chain4)
# thin2
...
MCH_marchspill_chain1 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_hatchery", "MCH_marchspill_chain1_fit.rds"))
MCH_marchspill_chain2 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_hatchery", "MCH_marchspill_chain2_fit.rds"))
MCH_marchspill_chain3 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_hatchery", "MCH_marchspill_chain3_fit.rds"))
MCH_marchspill_chain4 <- readRDS(here::here("Stan", "alternative_spill_treatment", "middle_columbia_hatchery", "MCH_marchspill_chain4_fit.rds"))

# bind chains together
MCH_fit_raw <- bind4chains(MCH_marchspill_chain1, MCH_marchspill_chain2, MCH_marchspill_chain3, MCH_marchspill_chain4)
# thin2
...
## Snake River, Wild
SRW_marchspill_chain1 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_wild", "SRW_marchspill_chain1_fit.rds"))
SRW_marchspill_chain2 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_wild", "SRW_marchspill_chain2_fit.rds"))
SRW_marchspill_chain3 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_wild", "SRW_marchspill_chain3_fit.rds"))
SRW_marchspill_chain4 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_wild", "SRW_marchspill_chain4_fit.rds"))

# bind chains together
SRW_fit_raw <- bind4chains(SRW_marchspill_chain1, SRW_marchspill_chain2, SRW_marchspill_chain3, SRW_marchspill_chain4)
# thin2
...
SRH_marchspill_chain1 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_hatchery", "SRH_marchspill_chain1_fit.rds"))
SRH_marchspill_chain2 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_hatchery", "SRH_marchspill_chain2_fit.rds"))
SRH_marchspill_chain3 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_hatchery", "SRH_marchspill_chain3_fit.rds"))
SRH_marchspill_chain4 <- readRDS(here::here("Stan", "alternative_spill_treatment", "snake_river_hatchery", "SRH_marchspill_chain4_fit.rds"))

# bind chains together
SRH_fit_raw <- bind4chains(SRH_marchspill_chain1, SRH_marchspill_chain2, SRH_marchspill_chain3, SRH_marchspill_chain4)
# thin2
