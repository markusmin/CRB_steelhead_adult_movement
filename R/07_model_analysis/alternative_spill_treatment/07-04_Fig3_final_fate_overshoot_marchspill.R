### 07-04_Fig3_final_fate_overshoot - MARCH SPILL SCENARIO
...
# Load the final fates simulation runs for each population
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "DES_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "ENT_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "FIF_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "JDR_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "MET_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "OKA_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "UMA_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "WAWA_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "WEN_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "YAK_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "ASO_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "CLE_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "SAL_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "GR_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "IMN_comp_data.rda"))
load(here::here("figures", "alternative_spill_treatment", "final_fates", "simulation_runs", "TUC_comp_data.rda"))

FF_comp_data <- vector(mode = "list")
  ...
  mutate(label_position = ifelse(abbrev == "DES" & rear == "wild" |
                                 ...
                                 ifelse(abbrev == "ENT" & rear == "wild" |
                                        ...
                                        ifelse(abbrev == "WEN" & rear == "hatchery" |
                                                 abbrev == "TUC" & rear == "hatchery", "bottomleft",
...
write.csv(FF_overshoot_comp_filter, here::here("figures", "alternative_spill_treatment", "paper_figures", "overshoot_probability_table_marchspill.csv"))
...
ggsave(here::here("figures", "alternative_spill_treatment", "paper_figures", "fig3_homing_v_overshoot_plot_marchspill.png"), fig3, height = 6, width = 8)
