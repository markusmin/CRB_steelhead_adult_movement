...
ggarrange(umatilla_fitted_DE_plot_era1, 
          ...
          walla_walla_fitted_DE_plot_era4,
                       ...
                       asotin_fitted_DE_plot_era2,
                       tucannon_fitted_DE_plot_era1,
                       tucannon_fitted_DE_plot_era2, ncol = 4, nrow = 5) -> DE_plots

ggsave(here::here("figures", "DE_plots.pdf"), DE_plots, height = 15, width = 20)

# should plot Imnaha and Fifteenmile as intercept only
```
