...
det_hist <- read.csv(here::here("intermediate_outputs", "complete_det_hist_postprocessed.csv"), row.names = 1)
```
...
```{r define_functions_plot_detection_efficiency_model_fit, eval = FALSE}
...
asotin_fitted_DE_plot_era1 <- DE_plot_function(predicted_DE_quantiles = asotin_predicted_DE_quantiles, 
                 run_year_det_eff_discharge_data = asotin_det_discharge_data, 
...
deschutes_det_discharge_data_era1 <- prep_det_discharge_data(tributary_name = "Deschutes River", 
                                                             ...
                                                             river_mouth_site_end_date = "2025-01-01",
                                                          discharge_data = all_tribs_discharge_zscore,
                                                          run_years = c("13/14", "14/15", "15/16", "16/17", "17/18", "18/19", "19/20"))
deschutes_fitted_DE_plot_era1 <- DE_plot_function(predicted_DE_quantiles = deschutes_predicted_DE_quantiles_era1, 
                                               ...
                                               plot_name = "Deschutes River (13/14-19/20)")
...
#                                                  niter = 1000, 
#                                                  nchains = 3)
# fifteenmile_det_discharge_data_era1 <- prep_det_discharge_data(tributary_name = "Fifteenmile Creek", 
...
# fifteenmile_fitted_DE_plot_era1 <- DE_plot_function(predicted_DE_quantiles = fifteenmile_predicted_DE_quantiles_era1, 
#                                                run_year_det_eff_discharge_data = fifteenmile_det_discharge_data_era1, 
...
#                                                  niter = 1000, 
#                                                  nchains = 3)
# imnaha_det_discharge_data_era1 <- prep_det_discharge_data(tributary_name = "Imnaha River", 
...
# imnaha_fitted_DE_plot_era1 <- DE_plot_function(predicted_DE_quantiles = imnaha_predicted_DE_quantiles_era1, 
#                                                run_year_det_eff_discharge_data = imnaha_det_discharge_data_era1, 
