#### FIT STAN MODEL - for Upper Columbia, Wild DPS ####
# CHAIN 4: Seed 104
...
load(file = "UCW_marchspill_model_data.rda")



# Fit stan model using cmdstan
# Step 1: load the model
mod <- cmdstan_model("UCW_model.stan", compile = FALSE)
...
fit$save_object(file = "UCW_marchspill_schain4_fit.rds")
