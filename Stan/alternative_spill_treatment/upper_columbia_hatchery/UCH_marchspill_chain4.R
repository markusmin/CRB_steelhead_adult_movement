#### FIT STAN MODEL - for Upper Columbia, Hatchery DPS ####
# CHAIN 4: Seed 104
...
load(file = "UCH_marchspill_model_data.rda")



# Fit stan model using cmdstan
# Step 1: load the model
mod <- cmdstan_model("UCH_model.stan", compile = FALSE)
...
fit$save_object(file = "UCH_marchspill_chain4_fit.rds")
