#### FIT STAN MODEL - for Middle Columbia, Wild DPS ####
# CHAIN 3: Seed 103
...
load(file = "MCW_marchspill_model_data.rda")



# Fit stan model using cmdstan
# Step 1: load the model
mod <- cmdstan_model("MCW_model.stan", compile = FALSE)
...
fit$save_object(file = "MCW_marchspill_chain3_fit.rds")
