#### FIT STAN MODEL - for Snake River, Hatchery DPS ####
# CHAIN 4: Seed 104
...
load(file = "SRH_NT_marchspill_model_data.rda")



# Fit stan model using cmdstan
# Step 1: load the model
mod <- cmdstan_model("SRH_NT_model.stan", compile = FALSE)
...
fit$save_object(file = "SRH_NT_marchspill_chain4_fit.rds")
