#### FIT STAN MODEL - for Middle Columbia, Hatchery DPS ####
# CHAIN 3: Seed 103
...
load(file = "MCH_marchspill_model_data.rda")



# Fit stan model using cmdstan
# Step 1: load the model
mod <- cmdstan_model("MCH_model.stan", compile = FALSE)
...
fit$save_object(file = "MCH_marchspill_chain3_fit.rds")
